...
<%@ page import="com.guimei.zyh.pojo.CartItem" %><%--
...
<div id="container">
    ...
    <div class="buy">
        ...
        <table class="buy" cellpadding="0" cellspacing="0">
            ...
            <c:forEach items="${requestScope.page.items}" var="CartRec">
                <tr>
                    <td>${CartRec.name}</td>
                    <td>${CartRec.pri}</td>
                    <td>${CartRec.nPri}</td>
                    <td>${CartRec.discount}</td>
                    <td><input id="num" name="num" >${CartRec.num}</td>
                    <td><a href="cartServlet?action=modifyCart&pid=${CartRec.pid}&num=$(num).val>修改</a></td>
                    <td><a href="cartServlet?action=deleteCartItem&pid=${cartItem.id}">删除</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        ...
        <form id="buyForm" method="post" action="orderServlet">

<%@ page import="com.guimei.zyh.dao.impl.ProductDaoImpl" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ page import="com.guimei.zyh.dao.ProductDao" %>
<%@ page import="com.guimei.zyh.service.ProductService" %>
<%@ page import="com.guimei.zyh.service.impl.ProductServiceImpl" %><%--
...
<div id="container">
    ...
    <table class="buy" cellpadding="0" cellspacing="0">
        ...
        <%
            ...
            String catName= request.getParameter("catName1");
            Integer pageNo=Integer.valueOf(request.getParameter("pageNo"));
            Integer pageSize=Integer.valueOf(request.getParameter("pageSize"));
            productService.page(catName,pageNo,pageSize);
        %>
